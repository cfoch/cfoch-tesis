...
y mejorarlo (sin mencionar otras libertades), se considera como la mejor opción
para desarrollar este proyecto pues tiene mejores características en
...
\section{GStreamer}
Es un proyecto de GNOME. GStreamer es una librería de código abiert y
multiplataforma escrita en C con bindings en varios otros lenguages de
programación. Está asada en GObject. GStreamer implementa un modelo de
...
En esta sección, se analiza qué librerías se debería escoger no solo por su
algoritmo sino también por la  El método a seguir en este análisis es el de la
revisión sistemática. En este método se plantea preguntas que son de la duda del
autor para posteriormente analizarlas a detalle.\\
...
con la licencia de Cheese. \textit{4dface} también se descarta porque no hay
